      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border">
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <img src="/favicon.jpg" alt="YOTEPUBLICO" className="h-10 w-10 rounded-lg" />
            <div>
              <div className="font-bold text-lg text-primary">AGENCIA</div>
              <div className="text-xs font-semibold text-muted-foreground">YOTEPUBLICO</div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <div className="inline-block">
              <div className="flex items-center justify-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-semibold">
            ...
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight">
              ...
              <span className="block text-primary mt-2">todas las redes sociales</span>
            </h1>
